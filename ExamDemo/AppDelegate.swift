...
//  ExamDemo
//
//  Created by Nikunj Prajapati on 31/12/19.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let dirs = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true)
        ...
        self.dbLocation = dirs.first! + "/ExamDemoDatabase.db"
        ...
        {
            let bundlePath = Bundle.main.path(forResource: "ExamDemoDatabase", ofType: "db")
            do
            {
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        ...
        */
        let container = NSPersistentCloudKitContainer(name: "ExamDemo")
